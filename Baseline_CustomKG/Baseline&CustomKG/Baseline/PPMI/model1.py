...
class KGMultiModalTransformer(nn.Module):
    ...
    """
    def __init__(self, ehr_dim=4, img_dim=64, bio_dim=37, embed_dim=16, num_heads=2, transe_embed_dim=128, max_seq_len=35, num_classes=3):
        super().__init__()
...
class EnhancedKGMultiModalTransformer(nn.Module):
    def __init__(self, embed_dim=128, num_heads=4, num_layers=2, transe_embed_dim=128, num_classes=3):
        super().__init__()
