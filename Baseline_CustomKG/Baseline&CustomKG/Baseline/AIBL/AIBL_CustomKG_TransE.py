...
os.chdir(r'd:\Polaris\Documents\work4\Baseline_CustomKG\Baseline&CustomKG\Baseline\AIBL')
import warnings
...
model = KGMultiModalTransformer_old(ehr_dim=1, img_dim=1, bio_dim=1, embed_dim=embed_dim, transe_embed_dim=transe_embed_dim).to(device)
