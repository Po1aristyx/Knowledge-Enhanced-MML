...
pd_seq, pd_mask               = process_and_verify_seq(pd_df, "E:/code/PPMI/PD")
control_seq, control_mask     = process_and_verify_seq(control_df, "E:/code/PPMI/Control")
prodromal_seq, prodromal_mask = process_and_verify_seq(prodromal_df, "Prodromal")
swedd_seq, swedd_mask         = process_and_verify_seq(swedd_df, "E:/code/PPMI/SWEDD")
